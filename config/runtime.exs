...
#
#     PHX_SERVER=true bin/fts3 start
#
...
config :fts3, :supabase,
  ...
  public_url: System.get_env("SUPABASE_PUBLIC_URL", "https://db.jam06452.uk"),
...
if config_env() == :prod do
  ...
  config :fts3, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :fts3, Fts3Web.Endpoint,
